...
void evaluation_data::read_from(tail* t){
    read_from(  inputdata::get_type(t),
...
void evaluation_data::read_to(tail* t){
    read_to(  inputdata::get_type(t),
                inputdata::get_index(t),
                inputdata::get_length(t),
                inputdata::get_symbol(t),
                inputdata::get_data(t)      );
...
void evaluation_function::initialize_globals(){
};
